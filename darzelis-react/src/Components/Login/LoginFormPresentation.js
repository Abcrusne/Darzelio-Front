...
const LoginFormPresentation = (props) => {
    ...
    return(
        <div className="col-lg-5 m-auto" onSubmit={props.handleSubmit}>
            <div className="mb-4">
                <h3>Prisijungti</h3>
            </div>
            <form className="form-group">
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control" id="exampleInputEmail1" autoComplete="username" aria-describedby="emailHelp" required/>
                </div>
                <div className="mb-3">
                    <label htmlFor="exampleInputPassword1" className="control-label">Slaptažodis</label>
                    <input type="password" className="form-control" id="exampleInputPassword1"  autoComplete="current-password" required/>
                </div>
