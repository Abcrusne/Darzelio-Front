  ...
  return (
    <div className="App">
      <BrowserRouter basename={process.env.PUBLIC_URL}>
        ...
        {/*  <Route exact path="/dashboard" component={ParentLanding} />*/}
        {/*  <Route exact path="/admin/pradzia" component={SysAdminLanding}/>*/}
        {/*  <Route exact path="/admin/edu" component={EduAdminLanding}/>*/}
          <Route
            exact
