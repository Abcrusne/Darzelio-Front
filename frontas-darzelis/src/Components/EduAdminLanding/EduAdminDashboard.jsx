        ...
        <div className='container mt-5'>
            ...
            <div className="row">
                ...
                <div className="card col">
                    <div className="card-body">
                        ...
                        <h6 className="card-subtitle mb-2 text-muted">3-6 m amžiaus vaikų grupėse</h6>
                        <p>Viso registracijų į darželius</p>
                    </div>
                </div>
                <div className="card col">
            ...
            <div className="statusas row mt-5 justify-content">
                <div className="col-8 shadow border rounded p-5">
                    <div className="">
                        <h5 className=" pb-3">Registracijų į darželius statusas: {isActive? "Registracija atidaryta" : "Registracija sustabdyta"}</h5>
