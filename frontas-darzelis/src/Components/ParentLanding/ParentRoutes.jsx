...
const ParentRoutes = () => {
    return (
            <Switch>
              ...
              <PrivateRoute path='/tevai/registracija' exact component={ParentRegistrationFormContainer}
                            role={"PARENT"}/>
              <PrivateRoute path='/tevai/registracija/redaguoti' exact component={UpdateParentRegistrationFormContainer}
                            role={"PARENT"}/>
              <PrivateRoute path='/tevai/vaikoregistracija' exact component={ChildrenRegistrationFormContainer}
                            role={"PARENT"}/>
              <PrivateRoute path="/tevai/toliau" exact component={NextPage}
                            role={'PARENT'}/>
              <PrivateRoute path='/tevai/registracija-i-darzeli' exact component={MainRegistrationContainer}
                            role={"PARENT"}/>
