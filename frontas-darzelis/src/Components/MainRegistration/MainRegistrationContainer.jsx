        ...
        return(
            ...
            >
                ...
                <div className="input-group mb-3">
                    ...
                    <select className="form-control" id="selectChild" onChange={this.handleChange} name="childId">
                        ...
                        {(children && children.length > 0) && children.map((child) => (
                            <option
                                ...
                                value={child.id}
                                >
                                {child.firstname + ' ' + child.lastname} {console.log(child.id)}
                            </option>
                        ))}
                    </select>
                </div>
                <div className="input-group mb-3">
                    ...
                    <select
                        ...
                        {(kindergartens && kindergartens.length > 0) && kindergartens.map((kindergarten, i) => (
                            <option
